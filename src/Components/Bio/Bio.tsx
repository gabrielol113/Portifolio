        ...
        <div className="flex flex-col min-h-screen items-center justify-center bg-black">
            ...
            <div className="flex justify-center mt-12">
                <Link
                    ...
                    className="group mx-4 p-2 text-white hover:scale-150 transition-all duration-700 hover:*:text-black  hover:bg-white rounded-lg border-2 border-white"
                >
                    <svg className="w-6 h-6 text-5xl group-hover:text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M13.795 10.533 20.68 2h-3.073l-5.255 6.517L7.69 2H1l7.806 10.91L1.47 22h3.074l5.705-7.07L15.31 22H22l-8.205-11.467Zm-2.38 2.95L9.97 11.464 4.36 3.627h2.31l4.528 6.317 1.443 2.02 6.018 8.409h-2.31l-4.934-6.89Z" />
                    </svg>
                </Link>
                <Link
                    href={'https://www.github.com/gabrielol113'}
                    className="group flex items-center justify-center mx-4 p-2 text-white hover:scale-150 transition-all duration-700 hover:*:text-black  hover:bg-white rounded-lg border-2 border-white"
                >   
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="-20 -10 300 300"
                        className="hover:text-black flex scale-125 group-hover:text-black">
                ...
                <Link
                    ...
                    className="group mx-4 p-2 text-white hover:scale-150 transition-all duration-700 hover:*:text-black  hover:bg-white rounded-lg border-2 border-white"
                >
                    <svg className="w-6 h-6 text-white dark:text-white group-hover:text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
